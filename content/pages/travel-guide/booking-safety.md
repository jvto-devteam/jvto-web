...
schemaTypes:
  - WebPage
summary: How to make sure you are booking and paying through JVTO's real, official channels.
---

Book and pay only through JVTO's official channels. Here is how to stay safe.

## Booking Safety & Anti-Fraud

Use only JVTO's official channels; JVTO never asks for full card numbers, CVV, banking passwords, or OTP codes.
...
- [How Booking Works](/travel-guide/how-booking-works)
