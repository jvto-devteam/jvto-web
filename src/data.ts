...
export const reviews: Review[] = reviewsData.map((r, index) => {
    ...
    if (sourceString.toLowerCase().includes('tripadvisor')) platform = 'tripadvisor';
    if (sourceString.toLowerCase().includes('trustpilot')) platform = 'trustpilot';
    if (sourceString.toLowerCase().includes('facebook')) platform = 'facebook';

    return {
        id: index + 1,
        name: r.Reviewer_Name,
        location: sourceString.split('(')[1]?.replace(')', '').trim() || 'Global Traveler',
        rating: parseInt(ratingString.split('/')[0], 10) || 5,
        text: r.Review_Text,
        platform: platform,
        avatar: `https://i.pravatar.cc/100?u=${encodeURIComponent(r.Reviewer_Name)}`,
        date: r.Review_Date,
...
export const galleryImages = [
    { id: 1, src: 'https://images.unsplash.com/photo-1589182373726-e4f658ab50f0?q=80&w=600&auto=format&fit=crop', alt: 'Mount Bromo sunrise view', location: 'Mount Bromo' },
    { id: 2, src: 'https://images.unsplash.com/photo-1596643533596-81534130043c?q=80&w=600&auto=format&fit=crop', alt: 'Ijen Crater turquoise lake', location: 'Ijen Crater' },
    { id: 3, src: 'https://images.unsplash.com/photo-1608231387042-6a74535b1b2a?q=80&w=600&auto=format&fit=crop', alt: 'Tumpak Sewu Waterfall cascade', location: 'Tumpak Sewu' },
    { id: 4, src: 'https://images.unsplash.com/photo-1622329383383-7a9b89b4c0a5?q=80&w=600&auto=format&fit=crop', alt: 'Madakaripura Waterfall canyon', location: 'Madakaripura' },
    { id: 5, src: 'https://images.unsplash.com/photo-1555165936-1a5cd4c59858?q=80&w=600&auto=format&fit=crop', alt: 'Jeep on the Sea of Sand at Bromo', location: 'Sea of Sand, Bromo' },
    { id: 6, src: 'https://images.unsplash.com/photo-1621215423303-12a87a1d7c31?q=80&w=600&auto=format&fit=crop', alt: 'Sulphur miner at Ijen Crater', location: 'Ijen Crater' },
    { id: 7, src: 'https://images.unsplash.com/photo-1549638363-e38714de1e6e?q=80&w=600&auto=format&fit=crop', alt: 'Viewpoint overlooking Mount Bromo caldera', location: 'Penanjakan Viewpoint' },
    { id: 8, src: 'https://images.unsplash.com/photo-1596422846543-162d9f102773?q=80&w=600&auto=format&fit=crop', alt: 'Colorful village of Jodipan, Malang', location: 'Jodipan, Malang' },
    { id: 9, src: 'https://storage.googleapis.com/aai-web-samples/pro-code/JVTO/mr-sam-tourist-selfie.jpg', alt: 'Founder Mr. Sam with a happy tourist near Mount Bromo', location: 'East Java' },
    { id: 10, src: 'https://storage.googleapis.com/aai-web-samples/pro-code/JVTO/mr-sam-tourist-group.jpg', alt: 'Founder Mr. Sam with guests at the JVTO office', location: 'JVTO Office' }
];
...
- **Legally Licensed & Accountable:** JVTO is a fully licensed Indonesian company with a physical office, ensuring full accountability.`,
  ...
  // Tour Packages & Features
  {
    ...
    content: 'All JVTO tours are exclusively private, all-inclusive itineraries run specifically for your party. We do not operate open join-in group tours, and we do not sell standalone "transport-only" services as our core product. This ensures higher quality, safety, and a more personal experience.',
    tags: ['tours', 'private', 'all-inclusive', 'shared tours', 'tour type', 'transport only']
  },
  {
    id: 'tour-customization',
    category: 'Tour Packages & Features',
    title: 'Itinerary Customization Policy',
    content: 'Our itineraries are integrated private services. Choosing to skip an attraction or leave an activity early does not reduce the tour package price. Major deviations from the confirmed route are not possible as logistics are locked in for your group.',
    tags: ['customization', 'customize', 'itinerary', 'flexible', 'changes', 'adjustments', 'skip']
  },
  {
    id: 'special-services',
    category: 'Tour Packages & Features',
    title: 'Special Services and Requests',
    content: 'Upon request, we can arrange for special services like professional photography, videographer services, or extra transfers. For large groups (18+), we can coordinate an official traffic police escort on specific routes, subject to approval by the relevant police unit. Drone usage by guests is permitted, but you must operate it safely.',
    tags: ['special services', 'photographer', 'videographer', 'drone', 'groups', 'requests', 'police escort']
  },
...
* **Step 4: Pay Remaining Balance:** Settle the balance by the deadline.`,
    tags: ['book', 'booking', 'reservation', 'website', 'how to book', 'checkout', 'confirmation', 'voucher', 'pickup details']
  },
  {
    id: 'payment-terms',
    category: 'Payment & Booking',
    title: 'Payment Terms and Deposit',
    content: 'A **20% deposit** is required to secure your tour. For **bookings made less than 14 days before departure, 100% full payment** is required upfront. Missing a payment deadline can result in booking cancellation.',
    tags: ['payment', 'terms', 'deposit', 'invoice', 'balance', 'due date', 'upfront', 'last-minute']
  },
  {
    id: 'payment-methods',
    category: 'Payment & Booking',
...
Payments to non-official channels or personal accounts are at your own risk.`,
  ...
  },
  {
    ...
    content: 'All online card payments are processed via a secure, SSL-encrypted checkout. JVTO does not store full card numbers. **JVTO will never ask you to send full card numbers, CVV, or banking credentials via email or unsecured chat.**',
    tags: ['payment security', 'secure', 'ssl', 'credit card', 'scam', 'fraud', 'safe payment']
  },
   {
...
* **No cash refunds are ever issued.** Travel Credit is the only form of compensation for eligible cancellations.`,
    tags: ["cancellation", "refund", "policy", "cancel", "48 hours", "no-show", "travel credit", "forfeited"]
  },
  {
...
* **Request LESS than 48 hours before Day 1:** Rescheduling is **not available**. Your request is treated as a late cancellation, and payment is forfeited.`,
    tags: ["reschedule", "rescheduling", "policy", "availability", "48 hours", "free", "change date"]
  },
  ...
  // Logistics & Timing
  {
    ...
    content: 'We offer flexible pick-up and drop-off points, including Surabaya (airport, hotel, train station), Malang, and Bali-origin handovers. Drop-off can be at a different location than pickup.',
    tags: ['pickup', 'dropoff', 'start location', 'end location', 'surabaya', 'malang', 'bali', 'ketapang']
  },
  ...
  // Inclusions & Exclusions
  {
    ...
    content: 'Our all-inclusive private tours typically cover: private transport, accommodation with breakfast, all entrance fees & permits, Bromo 4WD Jeep, Ijen health screening, professional safety gear (gas mask, poles), bottled water, and a JVTO travel T-shirt.',
    tags: ['inclusions', 'included', 'all-inclusive', 'what is included', 'package', 'gear', 'ijen medical']
  },
  {
    id: 'exclusions-summary',
    category: 'Inclusions & Exclusions',
    title: 'Summary of Tour Exclusions',
    content: 'Unless explicitly listed, the following are excluded: flights, visas, travel insurance, meals not stated as included (e.g., lunches, dinners), tips, and personal expenses.',
    tags: ['exclusions', 'not included', 'extra cost', 'optional', 'add-ons', 'personal expenses']
  },
  ...
  // Health, Safety & Packing
  {
    ...
    content: 'Safety is our top priority. Guests must follow all instructions from JVTO crew and local authorities. Mandatory seatbelt use is required. JVTO may remove a traveler for behavior that creates a safety risk.',
  ...
  },
  {
    ...
    content: 'A medical certificate is **mandatory** to enter Mount Ijen, as enforced by local authorities. JVTO arranges this screening for you, and it is **included in the tour price**. A licensed medical professional performs the check. You must show your passport or valid ID.',
    tags: ['ijen', 'health certificate', 'medical check', 'doctor', 'requirement', 'safety', 'fee', 'nurse']
  },
  {
    id: 'ijen-health-contingency',
    category: 'Health, Safety & Packing',
    title: 'Contingency Plan if Unfit for Ijen Trek',
    content: 'If the medical professional determines you are not fit to hike Ijen, you will not be permitted to enter for your own safety. The tour will continue, but there is **no partial cash refund or compensation** for the missed hike, as all costs were pre-committed.',
  ...
  },
  {
    ...
    content: 'Travel insurance is **not included** but is highly recommended. JVTO is not responsible for costs you incur outside the tour itself.',
    tags: ['travel insurance', 'insurance', 'policy', 'emergency', 'medical', 'optional']
  },
   {
    id: 'force-majeure',
    category: 'Health, Safety & Packing',
    title: 'Changes due to Force Majeure / Safety',
    content: 'If safety, regulations, or external events (e.g., volcanic activity, severe weather, park closures) require changes, JVTO may adjust itineraries. We aim to offer alternatives of equal or higher standard. Where significant components are cancelled by JVTO, we may offer alternatives, Travel Credit, or a partial refund (net of unrecoverable costs).',
    tags: ['force majeure', 'volcano closure', 'bad weather', 'safety changes', 'cancellation by jvto']
  },
  ...
  // Privacy & Data
  {
    ...
    content: 'JVTO collects only data reasonably required to operate tours, comply with regulations, and protect safety. This includes identification, contact details, booking details, and necessary health information. We apply technical and organizational safeguards to protect your data.',
  ...
  // --- NEW KNOWLEDGE BASE FROM PROVIDED FILES ---
  {
    ...
    content: 'Kawah Ijen lies in East Java, Indonesia, between Banyuwangi and Bondowoso Regencies, at coordinates 8.058° S, 114.242° E.',
  ...
  },
  {
    ...
    content: 'It is globally known for its turquoise acidic crater lake and the rare “blue fire” phenomenon caused by burning sulfuric gas.',
  ...
  },
  {
    ...
    content: 'The summit reaches 2,799 meters, with the crater rim around 2,386 meters above sea level.',
  ...
  },
  {
    ...
    content: 'Between May and October during the dry season — clear skies, minimal fog, and the best visibility for blue fire and sunrise.',
  ...
  },
  {
    ...
    content: 'The blue fire is visible between 01:00–04:00 AM before sunrise when the temperature and wind are stable.',
  ...
  },
  {
    ...
    content: 'Moderate (3/5). The round trip is about 6 km with ~530 m elevation gain.',
  ...
  },
  {
    ...
    content: 'No. The lake has a pH of 0.2–0.5 and contains sulfuric acid; it can cause severe burns.',
  ...
  },
  {
    ...
    content: 'Yes, especially when descending toward the crater floor due to sulfur gas exposure.',
  ...
  },
  {
    ...
    content: 'In the Bromo Tengger Semeru National Park, East Java, near Sukapura and Cemoro Lawang.',
  ...
  },
  {
    ...
    content: 'For its sunrise views over the Tengger Caldera and its active smoking crater.',
  ...
  },
  {
    ...
    content: 'The Javanese term means “a thousand waterfalls,” referring to its multi-stream cascade.',
  ...
  },
  {
    ...
    content: 'Moderate to hard (3.5/5), involving ropes, bamboo ladders, and slippery rocks.',
...
Semeru’s eruptions feed the Glidik River (creating Tumpak Sewu), whose sediments shape Papuma’s coastal cliffs, and whose tectonic belt links to Ijen’s geothermal system. A tour route follows the geological life cycle of Java: fire → water → ocean.`,
    tags: ['geology', 'volcanoes', 'semeru', 'bromo', 'ijen', 'tumpak sewu', 'tectonics']
  },
  {
...
* **Ocean (Segara):** Represented by Papuma, symbolizing balance and unity where the cycle completes.`,
    tags: ['culture', 'spiritual', 'javanese', 'cosmology', 'philosophy', 'elements']
  }
];