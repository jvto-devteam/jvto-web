...
import type { PackageData } from '@/app/types';
...
const PackageDetail: FC<{ pkg: PackageData }> = ({ pkg }) => {
  ...
  const tourUrl = `${baseUrl}/tours/${pkg.id}`;
...
export default function App(pkg) {    
  return <PackageDetail pkg={pkg.pkg} />;
}
