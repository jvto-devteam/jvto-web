    ...
    "@graph": [
      {
        ...
        image: ["{{PLACEHOLDER_URL_IMAGE_ORGANIZATION}}"],
      ...
      },
      {
        ...
        primaryImageOfPage: "{{PLACEHOLDER_URL_HERO_IMAGE}}",
        breadcrumb: {
        ...
        hasPart: [
          ...
          },
          {
            "@type": "WebPage",
            "@id":
              siteUrl+"/why-jvto/reviews#webpage",
      ...
      },
      {
        ...
        "@id":
          siteUrl+"/destinations/mount-bromo#destination",
        name: "Mount Bromo",
      },
      {
        "@type": "TouristAttraction",
        "@id":
          siteUrl+"/destinations/ijen-crater#destination",
        name: "Ijen Crater",
      },
      {
        "@type": "TouristAttraction",
        "@id":
          siteUrl+"/destinations/tumpak-sewu-waterfall#destination",
        name: "Tumpak Sewu Waterfall",
      },
      {
        "@type": "TouristAttraction",
        "@id":
          siteUrl+"/destinations/madakaripura-waterfall#destination",
        name: "Madakaripura Waterfall",
      },
      {
        "@type": "TouristAttraction",
        "@id":
          siteUrl+"/destinations/papuma-beach#destination",
        name: "Papuma Beach",
      },
    ],
  };
