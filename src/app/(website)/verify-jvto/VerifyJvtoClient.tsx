...
export default function VerifyJvtoClient() {
  ...
  // Pastikan hanya menampilkan dokumen yg valid (punya gambar/preview)
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredDocuments.map((doc, i) => {
                ...
                // Visual Cues untuk Otoritas Tinggi
                    ...
                    <CardContent className="flex flex-col flex-grow p-6 bg-white">
                      ...
                      <div className="mt-auto">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <Button
                            className={`w-full text-xs font-bold ${hasExternalLink ? "col-span-1 " + whiteButtonClass : "col-span-2 " + greenButtonClass}`}
                            asChild
                          >
                            <a
                              href={doc.url}
