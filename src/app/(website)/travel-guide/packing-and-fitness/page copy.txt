...
export const metadata: Metadata = {
  ...
  description:
    "A practical guide on what to pack and the fitness levels required for your private tour in East Java. Prepare for volcano treks and waterfalls..",
};

// Konstanta slug untuk halaman ini
const PAGE_SLUG = "travel-guide/packing-and-fitness";
...
export default async function PackingAndFitness() {
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="text-center mb-12">
              ...
              <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
                A practical guide on what to pack and the fitness levels
                required for your private tour in East Java. Prepare for volcano
