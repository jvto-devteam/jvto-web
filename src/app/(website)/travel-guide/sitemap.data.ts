...
export function sitemapTravelGuide(t: Date): MetadataRoute.Sitemap {
  return [
    ...
    { url: url("/travel-guide/inclusions-exclusions-policy"), lastModified: t, changeFrequency: "monthly", priority: 0.8 },
    { url: url("/travel-guide/privacy-policy"), lastModified: t, changeFrequency: "monthly", priority: 0.8 },
  ];
}
