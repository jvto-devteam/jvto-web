...
// Fallback copy — only used if content/pages/travel-guide/booking-information.md
// is ever unavailable at build/runtime (should not happen; kept for safety).
const FALLBACK_SEO = {
  title: "Booking Information — JVTO Travel Guide",
  description:
    "How to book, pay, and cancel a JVTO private tour: website-only booking, 20% deposit, balance deadlines, and Lifetime Package Credit.",
};
...
/**
 * Hero fact card — presentational chrome only. Every figure here is mirrored in
 * content/pages/travel-guide/booking-information.md (20% deposit, card balance
 * ≤ 5 days before Day 1, website-only booking, E-Voucher as booking reference).
 */
const HERO_META_ROWS = [
  { label: "Deposit", value: "20%" },
  { label: "Balance due", value: "≤ 5 days before Day 1" },
  { label: "Book via", value: "Official website only" },
      ...
      >
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-12 md:gap-16">
            ...
            {/* Article body — prose driven by content/pages/travel-guide/booking-information.md */}
            <article className="bg-white rounded-[20px] p-8 md:p-12 border border-[#E3E0DA] min-w-0">
              ...
              <Faq items={faqItems} title="Booking: Common Questions" />
            </article>
          </div>
        </div>
      </section>
