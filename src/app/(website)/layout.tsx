    ...
    <Providers>
      <div className={`bg-background-light dark:bg-background-dark font-display text-ink-neutral-700 dark:text-ink-neutral-300 ${rubik.variable}`}>
        ...
        <div className="min-h-screen flex flex-col bg-white">
          <a
            href="#main-content"
            className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[9999] focus:px-4 focus:py-2 focus:bg-white focus:text-jvto-dark focus:font-bold focus:rounded focus:shadow-lg"
          >
