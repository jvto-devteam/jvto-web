...
export const metadata: Metadata = {
    ...
    description: "The standards behind JVTO: tourist police-led safety culture, registered Indonesian travel company, private all-inclusive tours, real Ijen health screening, local guides and student fairness.",
};
  ...
  const pillars = [
    {
      ...
      description: "JVTO is founded and led by an active tourist police officer in East Java. This influences our work in concrete ways:",
      points: [
      ...
      links: [
        { text: "Police escort for groups", href: "/travel-guide/police-escort-for-groups" },
        { text: "Safety on tours", href: "/travel-guide/safety-on-tours" },
        { text: "Weather and closures", href: "/travel-guide/weather-and-closures" }
      ]
    },
    {
      number: "02",
      title: "Registered & Verifiable Travel Company",
      description: "JVTO operates as a registered Indonesian travel company based in Bondowoso. You can verify:",
      points: [
      ...
      links: [
        { text: "Verify all documents", href: "/verify-jvto" }
      ],
    ...
    },
    {
      ...
      description: "All JVTO itineraries are private only. We design programs to be all-inclusive and transparent, with typical inclusions such as:",
      points: [
      ...
      links: [
        { text: "What's included and excluded", href: "/travel-guide/inclusions-exclusions-policy" }
      ],
    ...
    },
    {
      ...
      description: "We treat Ijen as a serious hike, not a casual walk. For tours that include Ijen, JVTO:",
      points: [
      ...
      links: [
        { text: "Ijen health screening explained", href: "/travel-guide/ijen-health-screening" }
      ],
    ...
    },
    {
      ...
      description: "We hire and train local guides, drivers and staff from the communities along the Bromo–Ijen–Tumpak Sewu corridor. Our standards include:",
      points: [
    ...
    },
    {
      ...
      description: "With ISIC, we support eligible international students who face higher park and travel costs:",
      points: [
    ...
    },
    {
      ...
      description: "We keep all practical rules in one place so there is no guesswork:",
      points: [
      ...
      links: [
        ...
        { text: "Booking information", href: "/travel-guide/booking-information" }
      ],
       ...
       <div className="flex flex-col min-h-screen bg-background">
        ...
        <section className="py-12 md:py-16 bg-accent border-b">
            <div className="container mx-auto px-4 max-w-4xl text-center">
             <nav className="mb-8 text-sm text-muted-foreground">
                ...
                <span className="text-foreground font-medium">The JVTO Difference</span>
            </nav>
              <h1 className="font-black text-2xl md:text-5xl">
                The JVTO Difference – Tourist Police-Led, Private & Transparent
              </h1>
              <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
                This page turns our story into clear standards. These are the rules we operate by so you know what to expect before you book.
              </p>
               <div className="mt-6 bg-primary/10 border border-primary/20 rounded-sm p-4 inline-block">
                    <p className="text-primary font-medium text-sm md:text-base">
                        Whenever you need detailed rules or conditions, please refer to our <Link href="/travel-guide" className="underline hover:text-primary/80">Travel Guide</Link>.
                    </p>
                </div>
            </div>
        </section>
                ...
                <div className="space-y-12">
                    ...
                    <div key={pillar.number} className="relative">
                        ...
                        {pillar.note && (
                            ...
                            <p className="text-muted-foreground text-sm">{pillar.note}</p>
                            </div>
                        )}
                        </div>
                    </div>
        ...
        <section className="py-16 bg-accent border-t">
            <div className="container mx-auto px-4 text-center max-w-3xl">
                <h2 className="font-black text-2xl md:text-5xl mb-4">Ready to Experience the Difference?</h2>
                <p className="text-muted-foreground mb-8 text-lg">
                    Book a private tour with a company you can verify — tourist police-led, registered, and community-rooted.
                </p>
