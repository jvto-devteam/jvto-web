...
export const metadata: Metadata = {
    ...
    description: 'How JVTO grew from a local homestay into a tourist police-led, registered East Java travel company with real health screening and community partnerships.',
};
            ...
            <div className="container mx-auto px-4 max-w-4xl">
              ...
              <div className="prose prose-lg max-w-none mx-auto text-muted-foreground space-y-12">
                ...
                {sections.map((section, secIndex) => (
                   <section key={secIndex} className={section.isCentered ? 'text-center not-prose' : ''}>
                      <h2 className="font-black uppercase text-3xl tracking-tight mt-12 mb-4 text-foreground">{section.title}</h2>
                      
                      {section.isCentered ? 
                        <p className="mt-4 text-muted-foreground max-w-3xl mx-auto">{section.content[0]}</p>
                      ...
                      {section.images && (
                       ...
                       {section.cta && (
                         <div className={`mt-6 ${section.isCentered ? 'flex justify-center gap-4' : ''}`}>
                            <Button variant={(section.cta.variant as any) || 'default'}>
