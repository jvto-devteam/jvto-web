  ...
  return (
    <Container>
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <ButtonLink href="/why-jvto/proof-transparency/press-recognition/">Open press proof</ButtonLink>
        <ButtonLink variant="secondary" href="/why-jvto/proof-transparency/history-artifacts/">
      ...
      <Section title="Proof library (recommended)">
        <Notice title="Use the proof spokes">
          <div className="mt-2 space-y-2">
            <div>
              Press proof: <a className="underline underline-offset-4" href="/why-jvto/proof-transparency/press-recognition/">/why-jvto/proof-transparency/press-recognition/</a>
            </div>
            <div>
              History artifacts: <a className="underline underline-offset-4" href="/why-jvto/proof-transparency/history-artifacts/">/why-jvto/proof-transparency/history-artifacts/</a>
            </div>
          </div>
        </Notice>
      </Section>
