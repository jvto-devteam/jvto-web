...
type FormState = {
  ...
  // kolom baru (string di form, array/number saat submit)
  ...
  terrain: string;
  safety_advisory: string; // comma separated
};
...
export default function CmsDestinationsPage() {
  ...
  const [deletingDestAssetId, setDeletingDestAssetId] = useState<
    number | null
  >(null);
      ...
      const normalized: Destination[] = data.map((d) => ({
        ...
        elevation_m:
          typeof d.elevation_m === "number"
            ...
            : null,
        key_highlights: Array.isArray(d.key_highlights)
          ? d.key_highlights
          : [],
  ...
  const openEditModal = (d: Destination) => {
    ...
    setForm({
      ...
      long: d.long != null ? String(d.long) : "",
      elevation_m: d.elevation_m != null ? String(d.elevation_m) : "",
      key_highlights: joinArrayToCommaString(d.key_highlights),
      temperature_range: d.temperature_range ?? "",
      terrain: d.terrain ?? "",
      safety_advisory: joinArrayToCommaString(d.safety_advisory),
    });
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const payload: any = {
        ...
        lat: parseNumberOrNull(form.lat),
        long: parseNumberOrNull(form.long),
        elevation_m: parseNumberOrNull(form.elevation_m),
        ...
        safety_advisory: parseArrayFromCommaString(form.safety_advisory),
      };
  ...
  const handleAssetPicked = (asset: PickerAsset) => {
    ...
    if (editingId) {
      ...
      setPendingAssets((prev) => [...prev, { asset, type: assetPickerTargetType }]);
    }
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-slate-500 flex items-center gap-1">
              ...
              Gunakan <span className="font-semibold">Edit</span> untuk
              mengubah detail & gallery image.
            </p>
          </div>
        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-950/70 backdrop-blur-sm">
          <div className="relative z-50 w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-xl border border-slate-800 bg-slate-950 shadow-2xl flex flex-col">
            ...
            >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        ...
                        placeholder="Contoh: Blue fire, sunrise view, sulphur miners..."
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-900/60 border border-slate-800 rounded-md px-3 py-2 text-xs text-slate-50 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                        placeholder="volcano, crater, lake"
                      />
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-1">
                        ...
                        <textarea
                          ...
                          rows={2}
                          className="w-full bg-slate-900/60 border border-slate-800 rounded-md px-3 py-2 text-xs text-slate-50 focus:outline-none focus:ring-1 focus:ring-emerald-500 nice-scrollbar"
                          placeholder="Musim hujan, kemarau, dll."
                        />
                      </div>
                      <div className="space-y-1">
                        <label className="block text-[11px] font-medium text-slate-300">
                        ...
                        <textarea
                          ...
                          rows={2}
                          className="w-full bg-slate-900/60 border border-slate-800 rounded-md px-3 py-2 text-xs text-slate-50 focus:outline-none focus:ring-1 focus:ring-emerald-500 nice-scrollbar"
                          placeholder="Light / moderate / heavy... bulan apa saja."
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="border border-slate-800 rounded-lg p-3 bg-slate-950/60 space-y-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-900/60 border border-slate-800 rounded-md px-3 py-1.5 text-xs text-slate-50 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                      placeholder="Contoh: 5–18°C (malam), 15–25°C (siang)"
                    />
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      value={form.terrain}
                      onChange={(e) =>
                        setForm((prev) => ({ ...prev, terrain: e.target.value }))
                      }
                      rows={2}
                      className="w-full bg-slate-900/60 border border-slate-800 rounded-md px-3 py-2 text-xs text-slate-50 focus:outline-none focus:ring-1 focus:ring-emerald-500 nice-scrollbar"
                      placeholder="Contoh: volcanic ash, rocky, forest trail..."
                    />
                  </div>
                </div>
                ...
                <div className="border border-slate-800 rounded-lg p-3 bg-slate-950/60 space-y-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      rows={2}
                      className="w-full bg-slate-900/60 border border-slate-800 rounded-md px-3 py-2 text-xs text-slate-50 focus:outline-none focus:ring-1 focus:ring-emerald-500 nice-scrollbar"
                      placeholder="Panjang trek, durasi, elevasi gain..."
                    />
                  </div>
                  ...
                  <div className="space-y-1">
                    <label className="block text-[11px] font-medium text-slate-300">
                      Safety Advisory (comma separated)
                    </label>
                    <input
                      ...
                      onChange={(e) =>
                        setForm((prev) => ({
                          ...prev,
                          safety_advisory: e.target.value,
                        }))
                      }
                      className="w-full bg-slate-900/60 border border-slate-800 rounded-md px-3 py-1.5 text-xs text-slate-50 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                      placeholder="no heart condition, no pregnancy, ..."
                    />
                    <p className="text-[10px] text-slate-500">
                      Contoh:{" "}
                      <code>no heart condition, no pregnancy, asthma disclose</code>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="border border-slate-800 rounded-lg p-3 space-y-3 bg-slate-950/60">
                <div className="flex items-center justify-between gap-2">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500">
                      Pilih gambar dari <b>Assets Manager</b> sebagai gallery
                      destinasi (primary / secondary).
                    </p>
                  </div>
                  <Link
                    href="/cms/assets"
                ...
                {!editingId && (
                  <div className="text-[11px] text-slate-400 bg-slate-900/70 border border-slate-800 rounded-md px-3 py-2">
                    ...
                    <span className="font-semibold">Simpan Destination</span>.
                  </div>
                )}
                  ...
                  <div className="flex flex-col md:flex-row gap-2 md:items-center">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button
                        type="button"
                        onClick={() =>
                          handleAddDestinationAsset("primary")
                        }
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between gap-2">
                                <div className="text-[11px] text-slate-100 truncate">
                                  {da.asset?.name || `Asset #${da.asset_id}`}
                                </div>
                                <span
                                  className={[
                    ...
                    <>
                      {pendingAssets.length === 0 ? (
                        <div className="text-[11px] text-slate-500 py-2">
                          ...
                          <b>Pick Primary</b> atau <b>Pick Secondary</b> di atas.
                        </div>
                      ) : (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="mt-1 flex flex-wrap gap-1">
                                  <button
                                    type="button"
                                    onClick={() =>
                                      handleChangePendingType(idx, "primary")
                                    }
                                    className="px-1.5 py-0.5 rounded-md border border-emerald-500/40 bg-emerald-500/10 text-[10px] text-emerald-300 hover:bg-emerald-500/20"
                                  >
                                    Set Primary
              ...
              {/* Thumbnail URL (optional quick mapping) */}
              {/* <div className="border border-slate-800 rounded-lg p-3 bg-slate-950/60 space-y-2">
                <h3 className="text-xs font-semibold text-slate-100">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900/60 border border-slate-800 rounded-md px-3 py-1.5 text-xs text-slate-50 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                    placeholder="Opsional, bisa diisi manual atau di-generate dari destination_assets di backend."
                  />
                </div>
              </div> */}
      ...
      <div className="w-full max-w-3xl max-h-[80vh] rounded-xl border border-slate-800 bg-slate-950/95 shadow-2xl flex flex-col">
        <div className="flex items-center justify-between px-4 py-3 border-b border-slate-800 bg-slate-950/90">
          <div>
            ...
            <p className="text-[11px] text-slate-500">
              Hanya menampilkan assets bertipe <span className="font-mono">image</span>.
            </p>
          </div>
          <button
            onClick={onClose}
