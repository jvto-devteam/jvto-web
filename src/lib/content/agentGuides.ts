// AUTO-GENERATED by scratchpad/gen_guides.py from knowledge-catalog general-modules.
...
export const AGENT_GUIDES: Record<string, AgentGuide> = {
  ...
  "blue-fire-and-sunrise": {
    ...
    "description": "Why weather-dependent sights like Ijen's blue fire and a clear sunrise cannot be promised.",
