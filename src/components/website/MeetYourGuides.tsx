  ...
  return (
    <div className="group relative aspect-[3/4] w-full rounded-sm overflow-hidden shadow-lg transform transition-transform duration-300 hover:-translate-y-2">
      <Image
        ...
        quality={90}
        priority={false} // true hanya kalau card ini di atas fold (misal 3-4 card pertama)
      />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-ink-primary dark:text-white mt-4">
            ...
            <div className="flex justify-center lg:justify-start my-6">
              ...
              >
                <path
                  d="M0 5L5.5 9.79902V0.200981L11 5L16.5 9.79902V0.200981L22 5L27.5 9.79902V0.200981L33 5L38.5 9.79902V0.200981L44 5L49.5 9.79902V0.200981L55 5L60.5 9.79902V0.200981L66 5L71.5 9.79902V0.200981L77 5L82.5 9.79902V0.200981L88 5"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  className="text-ink-neutral-300 dark:text-ink-neutral-600"
                />
              </svg>
            </div>
            <p className="mt-4 text-ink-neutral-700 dark:text-ink-neutral-300 max-w-lg mx-auto lg:mx-0">
              Our guides are not just experts; they are local storytellers,
              safety professionals, and your personal connection to the culture
              of East Java. Meet the people who make your journey unforgettable.
            </p>
            <Link
