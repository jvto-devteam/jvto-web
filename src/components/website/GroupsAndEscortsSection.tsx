...
const GroupsAndEscortsSection = () => (
    <div className="py-12 bg-background-light dark:bg-ink-primary">
        <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center bg-white dark:bg-background-dark p-8 rounded-2xl shadow-sm border border-ink-neutral-200 dark:border-ink-neutral-700">
