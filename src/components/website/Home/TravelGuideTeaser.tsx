        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/travel-guide" className="bg-jvto-green text-jvto-dark px-8 py-3 font-bold uppercase rounded-sm hover:bg-white transition-colors inline-flex items-center gap-2">
                Open Travel Guide <ArrowRight size={16} />
              </Link>
              <Link href="/contact" className="border-2 border-white text-white px-8 py-3 font-bold uppercase rounded-sm hover:bg-white hover:text-jvto-dark transition-colors">
                Contact Us
              </Link>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link href="/travel-guide/faq" className="bg-gray-800 p-6 rounded-sm hover:bg-gray-700 transition-colors border border-gray-700 group">
              ...
              <Link href="/travel-guide/booking-information" className="bg-gray-800 p-6 rounded-sm hover:bg-gray-700 transition-colors border border-gray-700 group">
              ...
              <Link href="/travel-guide/ijen-health-screening" className="bg-gray-800 p-6 rounded-sm hover:bg-gray-700 transition-colors border border-gray-700 group">
                <div className="text-jvto-green mb-4 font-black text-2xl group-hover:scale-110 transition-transform origin-left">+</div>
              ...
              <Link href="/travel-guide/safety-on-tours" className="bg-gray-800 p-6 rounded-sm hover:bg-gray-700 transition-colors border border-gray-700 group">
                <div className="text-jvto-green mb-4 font-black text-2xl group-hover:scale-110 transition-transform origin-left">!</div>
