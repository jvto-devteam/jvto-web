...
export default function HomeTrustStrip() {
  return (
    <div className="bg-jvto-navy">
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-3 flex flex-wrap items-center justify-center md:justify-start gap-x-1 gap-y-2">
        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white/40 mr-3 flex-shrink-0">
          Listed on
        </span>
