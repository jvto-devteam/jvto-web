...
const formatDate = (dateString) => {
  ...
  const ReviewCard = ({ review }) => {
    return (
      <div className="inline-block w-[calc(100vw-80px)] sm:w-[393px] h-[110px] mr-4 pl-5 align-top relative group">
        ...
        >
          ...
          <div className="flex text-[13px] text-[rgba(0,0,0,0.6)]">
            ...
            <div className="flex-shrink-0 ml-0.5">{formatDate(review.date)}</div>
          </div>
        </a>
      </div>
    );
  ...
  return (
    <div className="pt-12 pb-0 md:pb-12 w-full container mx-auto min-h-[150px] min-w-[300px] relative font-['Helvetica_Neue',Helvetica,Arial,sans-serif] text-xs text-[#191919]">
      {/* Left Section */}
      ...
      <div className="hidden md:block sm:float-left sm:w-[calc(100%-200px)] mt-5 sm:mt-0 overflow-hidden px-10 relative">
        ...
        <div className="overflow-hidden relative">
          <div
            ref={carouselRef}
            className="h-full relative whitespace-nowrap transition-transform duration-300 ease-in-out"
            style={{
