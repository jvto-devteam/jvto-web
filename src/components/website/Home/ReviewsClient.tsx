...
const TrustpilotWidget = ({
  ...
  const maxIndex = Math.max(0, mappedReviews.length - reviewsPerView);
    ...
    return (
      ...
      >
        <button
          ...
          } -translate-y-1/2 bg-transparent border-0 block min-h-6 min-w-6 w-6 p-0 outline-none hover:bg-jvto-navy/10 hover:p-2 hover:w-10 hover:h-10 hover:rounded-full transition-all ${
  ...
  return (
    <div className="mt-10 min-h-[150px] min-w-[300px] relative font-['Helvetica_Neue',Helvetica,Arial,sans-serif] text-xs text-jvto-navy">
      {/* Left Section */}
      <div className="text-center sm:float-left sm:w-[200px] z-[100]">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="block text-jvto-navy no-underline outline-none relative"
        >
