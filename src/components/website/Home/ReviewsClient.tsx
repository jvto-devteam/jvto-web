...
const TrustpilotWidget = ({
  ...
  return (
    <div className="mt-10 min-h-[150px] min-w-[300px] relative font-['Helvetica_Neue',Helvetica,Arial,sans-serif] text-xs text-white">
      {/* Left Section */}
      <div className="text-center sm:float-left sm:w-[200px] z-[100]">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="block text-white no-underline outline-none relative"
        >
