        ...
        <main className="container mx-auto px-4 py-12 md:py-16">
          <div className="max-w-3xl mx-auto prose dark:prose-invert prose-headings:text-ink-primary dark:prose-headings:text-white prose-headings:border-b prose-headings:border-ink-neutral-200 dark:prose-headings:border-ink-neutral-700 prose-headings:pb-2 prose-p:text-ink-neutral-700 dark:prose-p:text-ink-neutral-200 prose-li:text-ink-neutral-700 dark:prose-li:text-ink-neutral-200 prose-ul:list-disc prose-ul:ml-5 prose-strong:text-ink-primary dark:prose-strong:text-white">
            ...
            <section className="mt-8">
                ...
                <p><strong>{`"JVTO Package Credit" / "Package Credit"`}</strong><br/>
                ...
                <ul>
                    ...
                    <li>Package Credit is the <strong>only</strong> form of refund JVTO provides. JVTO does not issue cash refunds.</li>
                </ul>
            ...
            <section className="mt-8">
                ...
                If you cancel more than 48 hours before the scheduled pickup time on Day 1: You receive <strong>100% JVTO Package Credit</strong> equal to everything you have already paid for that booking. There is <strong>no cash refund</strong>.</p>
                <p><strong>5.2 Cancellation less than 48 hours before Day 1</strong><br/>
                If you cancel inside the 48-hour window before Day 1: Your payment is <strong>forfeited in full</strong>. <strong>No Package Credit</strong> is issued. <strong>No cash refund</strong> is issued. This is because logistics are already committed under your name.</p>
                <p><strong>5.3 Attempted {`"same-day"`} cancellation</strong><br/>
                If you try to cancel on the same calendar day as your scheduled pickup, that is treated as a no-show (see Section 8). Same rules: forfeited, no Package Credit, no reschedule.</p>
            </section>
            ...
            <section className="mt-8">
                ...
                Rescheduling is <strong>not available</strong>. Your request is treated as a late cancellation (Section 5.2). Payment is forfeited; there is no Package Credit.</p>
            ...
            <section className="mt-8">
                ...
                JVTO may, at its discretion: (a) adjust or replace activities/days with comparable alternatives, or (b) issue JVTO Package Credit for any unused portion, or (c) issue a refund minus unrecoverable costs already committed under your name (park permits, jeep allocation, etc.).</p>
            ...
            <section className="mt-8">
                ...
                <ul>
                    ...
                    <li><strong>No Package Credit</strong> is issued.</li>
