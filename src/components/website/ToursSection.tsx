...
const ToursSection: React.FC<ToursSectionProps> = ({
  ...
  return (
    <section className="py-12 md:py-24 bg-background-light dark:bg-ink-primary relative overflow-hidden">
      <div
        className="absolute inset-0 bg-repeat bg-center opacity-5 dark:opacity-20"
        style={{
          backgroundImage:
            'url(\'data:image/svg+xml,%3Csvg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="%230B1F3A" fill-opacity="0.4" fill-rule="evenodd"%3E%3Cpath d="M0 40L40 0H20L0 20M40 40V20L20 40"/%3E%3C/g%3E%3C/svg%3E\')',
        }}
      ></div>
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-ink-primary dark:text-white mt-2">
            {copy.title}
          </h2>
          <p className="mt-4 text-ink-neutral-500 dark:text-ink-neutral-300 text-lg max-w-2xl mx-auto">
            {copy.subhead}
          </p>
        </div>
        {isFilter && (
        ...
        {tours.length > 0 ? (
          ...
          <div className="text-center bg-white/30 dark:bg-ink-primary/50 backdrop-blur-sm p-8 rounded-2xl max-w-md mx-auto">
            ...
            />
            <h3 className="text-2xl font-bold text-ink-primary dark:text-white mt-4">
              No Matching Tours Found
            </h3>
            <p className="text-ink-neutral-700 dark:text-ink-neutral-200 mt-2">
