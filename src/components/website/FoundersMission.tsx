...
const renderTitle = (title: string) => {
    ...
    return parts.map((part, index) => {
        if (part.startsWith('**') && part.endsWith('**')) {
            // Use primary color for highlighting in the light theme
            return <span key={index} className="text-primary">{part.slice(2, -2)}</span>;
        }
        return part;
    });
};
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 md:order-1 text-center md:text-left">
            ...
            <div className="w-16 h-0.5 bg-primary mt-3 mb-5 mx-auto md:mx-0"></div>
            ...
            <div className="mt-10">
              <Link 
                ...
                onClick={() => onCtaClick('why_story', foundersMissionCopy.cta, 'founders_mission')}
